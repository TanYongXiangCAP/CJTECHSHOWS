...
namespace CJTechShow.Server.Data.Migrations
{
    ...
    [Migration("20240119082931_AddApplicationTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CJTechShow.Server.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("CJTechShow.Shared.Domain.Main", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CJTechShow.Shared.Domain.SponsorPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SponsorPages");
                });

            modelBuilder.Entity("CJTechShow.Shared.Domain.VendorPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CJTechShow.Shared.Domain.Visitor", b =>
                {
            ...
            modelBuilder.Entity("CJTechShow.Shared.Domain.Main", b =>
                {
                    b.HasOne("CJTechShow.Shared.Domain.Organizer", "OrganizerID")
                        .WithMany()
                        .HasForeignKey("OrganizerIDId");

                    b.HasOne("CJTechShow.Shared.Domain.VendorPage", "VendorID")
                        .WithMany()
            ...
            modelBuilder.Entity("CJTechShow.Shared.Domain.SponsorPage", b =>
                {
                    b.HasOne("CJTechShow.Shared.Domain.Main", "EventID")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CJTechShow.Server.Models.ApplicationUser", null)
                        .WithMany()
